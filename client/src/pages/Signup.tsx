    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "#EEECE0" }}>
      ...
      <div className="relative z-10 w-full max-w-md bg-white rounded-2xl shadow-lg p-8 lg:p-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl lg:text-2xl text-black" style={{ fontFamily: "Montagu Slab, serif" }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Label htmlFor="fullName" className="text-[#082658] text-lg font-normal mb-2 block">
              Full Name
            </Label>
            <Input
              id="fullName"
          ...
          <div>
            <Label htmlFor="confirmPassword" className="text-[#082658] text-lg font-normal mb-2 block">
              Confirm Password
            </Label>
            <Input
              id="confirmPassword"
